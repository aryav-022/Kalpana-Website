...
const Banner = (props) => {
    ...
    return (
        <section className={styles.banner}>
            ...
            >
                <div className={styles.years} ref={BannerLinks}>
                    {/*Pass a function "setActiveYear" which takes argument and modifies content based on year.*/}
                    <div className={styles.bannerLink} id="2022" onClick={() => setActiveYear(2022)}>2022</div>
                    <div className={styles.bannerLink} id="2021" onClick={() => setActiveYear(2021)}>2021</div>
                    <div className={styles.bannerLink} id="2020" onClick={() => setActiveYear(2020)}>2020</div>
                    <div className={styles.bannerLink} id="2019" onClick={() => setActiveYear(2019)}>2019</div>
                    <div className={styles.bannerLink} id="2018" onClick={() => setActiveYear(2018)}>2018</div>
                </div>
